...
SOURCE_URL="s3://aws-hcls-ml/public_assets_support_materials/guidance-for-protein-folding/compressed/bfd_metaclust_clu_complete_id30_c90_final_seq.sorted_opt.tar.gz"
