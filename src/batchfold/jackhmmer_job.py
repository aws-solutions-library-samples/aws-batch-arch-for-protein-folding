...
class JackhmmerJob(BatchFoldJob):
    ...
    def __attrs_post_init__(self) -> None:
        ...
        if self.use_small_bfd is False:
            ...
            command_list.extend([f"--use_small_bfd {self.use_small_bfd}"])
